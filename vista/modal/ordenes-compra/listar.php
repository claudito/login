...
foreach ($objeto->lista('OC') as $key => $value) 
{  
	
$aprobacion_documentos =  new Aprobacion_documentos($value['numero'],'OC');
...
<div class="panel panel-default">
	...
	<table  id="consulta" class="table table-bordered table-condensed">
		...
		<td style="text-align: center;">
		 ...
		 <a data-id="<?php echo $value['numero'];?>" id=""  class="btn btn-request btn-xs btn-primary"><i class="glyphicon glyphicon-book"></i></a>
